...
real(4) :: saved_strategy_psi_r, saved_strategy_chi_r, strategy_r
...
read(*,'(a)') C_file;
read(*,'(a)') Q_file;
read(*,*) saved_strategy_psi, saved_strategy_psi_r, max_iter_psi;
read(*,*) saved_strategy_chi, saved_strategy_chi_r, max_iter_chi;
...
&           saved_strategy_psi_r, max_iter_psi
print *, "chi's strategy, residue, iter: ", saved_strategy_chi, &
&           saved_strategy_chi_r, max_iter_chi
...
if(mode(1) == 0) then
    ...
    call solve_elliptic(max_iter_psi, strategy, strategy_r, psi, coe, f, wksp_O, nr, nz, err, 0)
...
call solve_elliptic(max_iter_chi, strategy, strategy_r, chi, coe, f, wksp_O, nr, nz, err, 0)
print *, "Relaxation uses ", strategy, " steps. Final residue is ", strategy_r, "."
